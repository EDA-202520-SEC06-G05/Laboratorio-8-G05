...
def print_menu():
    ...
    print("5- Consultar crimenes en un reporting area")
...
def main():
    ...
    while working:
        ...
        if int(inputs[0]) == 1:
            ...
            initial_area = input("Area Inicial: ")
            final_area = input("Area Final: ")
            total = logic.get_crimes_by_range_area(control, int(initial_area), int(final_area))
